...
const ANNOUNCEMENTS: string[] = [
  "Bienvenue ! Connectez-vous les mises à jour sont régulières. Le NOUVEAU GUIDE ADF 2026 sera disponible dans les prochains jours sur le site de l'ADF (https://adf.asso.fr/publications/)",
