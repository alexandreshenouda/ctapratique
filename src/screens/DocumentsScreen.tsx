...
const ANNOUNCEMENTS: string[] = [
  "Bienvenue ! Les mises à jour sont régulières. Le NOUVEAU GUIDE ADF 2026 sera disponible dans les prochains jours sur le site de l'ADF (https://adf.asso.fr/publications/)","Pour RECHERCHER UN DOCUMENT vous devez cliquez sur l'onglet TOUS avant de procéder à votre recherche",
