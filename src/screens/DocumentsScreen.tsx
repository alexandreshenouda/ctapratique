...
const ANNOUNCEMENTS: string[] = [
  "Bienvenue ! Connectez-vous les mises à jour sont régulières. Le <strong>NOUVEAU GUIDE ADF 2026</strong> sera disponible dans les prochains jours sur le site de l'ADF",
